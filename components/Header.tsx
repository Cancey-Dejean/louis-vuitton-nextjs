...
const Header = ({}: HeaderProps) => {
  ...
  return (
    <header className="fixed top-0 left-0 w-full h-[88px] z-10 flex items-center bg-transparent hover:bg-white transition-all duration-[.3s] ease-in-out group">
      <div className="px-[36px] flex flex-1 items-center justify-between text-white group-hover:text-black">
        ...
        <div className="absolute max-w-[227px] w-full mx-auto top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          <Link href="" className="block">
            <svg
              ...
              aria-hidden="true"
              className="h-[23px] w-full fill-white group-hover:fill-black transition-all duration-[.3s] ease-in-out"
            >
              <path
        ...
        <div className="flex items-center gap-[30px]">
          ...
          <button className="flex items-start">
            ...
            <span className="h-3 w-3 rounded-full border border-white bg-transparent flex items-center justify-center text-[8px] leading-3 text-white relative top-[-2px] group-hover:text-black group-hover:border-black">
              0
            </span>
          </button>
        </div>
