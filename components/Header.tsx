...
const Header = ({}: HeaderProps) => {
  ...
  return (
    <header className="fixed top-0 left-0 w-full h-[88px] flex items-center bg-transparent">
      <div className="px-[36px] flex flex-1 items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="flex items-start">
            ...
            <span className="h-3 w-3 rounded-full border border-black bg-black flex items-center justify-center text-[8px] leading-3 text-white relative top-[-2px]">
              0
            </span>
          </button>
        </div>
